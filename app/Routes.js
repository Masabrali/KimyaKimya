        ...
        <Router>
            <Modal>
                ...
                <Scene key="app" hideNavBar={ true }>
                    ...
                    <Scene key="invite" component={ Invite } title="Tell a Friend" backTitle="Settings" hideNavBar={ false } navigationBarStyle={ navigationBarStyle.concat([Styles.noBorderBottom]) } />
                </Scene>
