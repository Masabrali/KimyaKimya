...
class Website extends Component<Props> {
    ...
    componentDidMount() {
        return this.props.logScreen('Website', 'Website', { gender: this.props.user.gender, age: parseInt(Math.floor(moment.duration(moment(new Date()).diff(moment(this.props.user.birth))).asYears())) });
    }
